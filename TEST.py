...
conn_1 = pyodbc.connect('Driver={Devart ODBC Driver for SQLAzure};'
                      'Server=NRDOSQLPrX01;'
                      'Database=gData;'
...
def update_dp(value):
    ...
    conn_3 = pyodbc.connect('Driver={Devart ODBC Driver for SQLAzure};'
                      'Server=NRDOSQLPrX01;'
                      'Database=gData;'
                      'Trusted_Connection=yes;')
...
def update_graph(Site, ratings, range_slider):
    ...
    conn_4 = pyodbc.connect('Driver={Devart ODBC Driver for SQLAzure};'
                      'Server=NRDOSQLPrX01;'
                      'Database=gData;'
                      'Trusted_Connection=yes;')
